<template>
  <div  class="content countdown-timer">
    <p>Machine: {{ json_obj.machine.TotalResults }} Dates</p>
    <p> {{ json_obj.machine.Results }} </p>
    <br /><br />
    <p>Navigation: {{ json_obj.navigation.TotalResults }} Dates</p>
    <p> {{ json_obj.navigation.Results }} </p>
